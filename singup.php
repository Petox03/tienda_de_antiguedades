        ...
        <div class="col-12 col-md-4 mb-5 accessform animate__animated animate__zoomIn animate__faster">
            ...
            <form action="singup.php" method="POST">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        <label class="ml-1" for="contraseña">Repetir contraseña</label>
                        <input type="password" class="form-control" name="Rpass" id="Rcontraseña" placeholder="Repetir contraseña"
