<?php
  ...
  //Confirmación y ejecución de sentencia
    ...
    if($id == 1)
    {
      $data = "<a href='#' type='button' class='btn btn-color'>añadir producto</a>";
    }
    ...
    showProfile($view);
    echo "
      <a href='profile.php' type='button' class='btn btn-color'>Editar perfil</a>
      <a href='saldo.php' type='button' class='btn btn-color'>añadir saldo</a>
      ".$data."
    </div>";
    die("</div></body></html>");
  }
