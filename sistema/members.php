<?php 
  ...
  if (isset($_GET['view']))
  {
    ...
    showProfile($view);
    echo "<a data-role='button' data-inline='true' data-icon='edit'
    data-transition='slide' href='profile.php'>Edita tu perfil</a>
    <a class='mr-1' data-role='button' data-inline='true' data-icon='edit'
    data-transition='slide' href='saldo.php'>Añadir saldo</a>";
    die("</div></body></html>");
  }
